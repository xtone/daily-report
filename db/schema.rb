...
ActiveRecord::Schema[7.0].define(version: 2025_06_06_090254) do
  create_table "bills", charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
  ...
  create_table "estimates", charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.bigint "project_id"
    t.string "serial_no", null: false
    t.string "subject", null: false
    t.integer "amount", default: 0
  ...
  create_table "user_projects", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.integer "user_id"
    t.integer "project_id"
  ...
  create_table "user_role_associations", id: false, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.integer "user_id"
  ...
  create_table "user_roles", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.integer "role"
    t.datetime "created_at", precision: nil, null: false
    t.datetime "updated_at", precision: nil, null: false
  end
