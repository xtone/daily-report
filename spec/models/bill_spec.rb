...
RSpec.describe Bill, type: :model do
  ...
  describe '#tax_included_amount' do
    let(:bill) { create(:bill, amount: 100000) }
    ...
    it 'calculates tax included amount' do
      ...
      expect(bill.tax_included_amount).to eq(108000)
    end
    ...
    it 'floors the result' do
      ...
      allow(AppSettings).to receive(:consumption_tax_rate).and_return(0.08)
      bill.amount = 100001
      expect(bill.tax_included_amount).to eq(108001) # 100001 * 1.08 = 108001.08 -> 108001
    end
  end
end
